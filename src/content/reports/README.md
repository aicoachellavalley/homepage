...
2. **Closing sequence — three elements, in this order, before the italic publisher footer:**
   ...
   3. **Institutional publisher/footer block** — AICV org-published declaration + methodology transparency hook + .com/.org surface clarification + Desert Community Foundation fiscal sponsorship + "nodes, briefs, and reports are available at aicoachellavalley.com" callout.
