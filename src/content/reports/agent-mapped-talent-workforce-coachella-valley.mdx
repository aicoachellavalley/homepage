...
- **Pricing: 16 of 83 — 21.9 percent — display any rate, fee, or tuition** where an agent can reach it. The other **57 do not** (10 could not be determined). For the firms whose business is a negotiated service — staffing especially — **78.1 percent hide the price from the agent asking.**
- **Agent-visibility gap: 12 of 83 — 14.5 percent — score low or invisible** when an agent runs the obvious category-plus-city query. This is the **highest gap of the four categories AICV has mapped.** 31 score high, 40 medium, 12 low, 0 invisible.
